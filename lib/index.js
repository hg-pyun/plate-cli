...
const repositorys = require('../resources/repositorys.json');
...
program
    ...
    .usage('<boilerplate>')
    .command('boilerplate', 'generate a new boilerplate in current working directory')
...
program
    ...
    .action(function (boilerplate) {
        var repositoryInfo = repositorys[boilerplate];
